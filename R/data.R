...
#'   & 2 & 3 & 4 & 5 & 6 color additive regulations 21 CFR Parts 73, 74, 81, 82}
...
#'   \item{Substance}{The name of the ingredient as recognized by the FDA's Human
#'   Foods Program}
#'   \item{Reg col01, Reg col02, Reg col03, Reg col04, Reg col05, Reg col06}{Color
#'   additive regulations (21 CFR Parts 73, 74, 81, 82).}
