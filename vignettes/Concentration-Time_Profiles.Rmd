...
![The multi-curve plot output and download option for example 1.](GUI_CTP_RunSimEx1_2.png){width="100%"}
...
![The individual plots output and download option for example 1.](GUI_CTP_RunSimEx1_3.png){width="100%"}
...
![The simulation data download feature for example 1.](GUI_CTP_RunSimEx1_4.png){width="100%"}
...
![The toxicokinetic (TK) summary drop down table for example 1.](GUI_CTP_RunSimEx1_5.png){width="100%"}
...
![The completed model specifications tab for example 2.](GUI_CTP_ModelSpecEx2.png){width="100%"}
...
![The time course data download and simulation parameter data tab for example 2.](GUI_CTP_RunSimEx2_4.png){width="100%"}

<br/><br/>

![The TK summary data tab for example 2.](GUI_CTP_RunSimEx2_5.png){width="100%"}
...
![The completed general parameters tab for example 3.](GUI_CTP_GenParsEx3.png){width="100%"}
