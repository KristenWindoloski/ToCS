...
![The completed General Parameters tab for example 1.](IVIVE_Vignette_Images/Example1/GUI_IVIVE_GenParsEx1.png){width="100%"}
...
![The completed model specifications tab for example 1 showing the model card.](IVIVE_Vignette_Images/Example1/GUI_IVIVE_ModelSpecEx1_1.png){width="100%"}
...
library(knitr)
library(kableExtra)
SampleChemsToUpload <- read.csv("Sample_CSV_Files/SampleBioData_8Chems.csv")
...
library(knitr)
library(kableExtra)
SampleChemsToUpload <- read.csv("Sample_CSV_Files/SampleExpData_8Chems.csv")
...
![The completed compound selection tab for example 1.](IVIVE_Vignette_Images/Example1/GUI_IVIVE_CompSelectEx1.png){width="100%"}
...
![The completed advanced parameters tab for example 1.](IVIVE_Vignette_Images/Example1/GUI_IVIVE_AdvParsEx1.png){width="100%"}
...
![The completed run simulation tab for example 1 showing the expanded OED table tab.](IVIVE_Vignette_Images/Example1/GUI_IVIVE_RunSimEx1_1.png){width="100%"}
...
![The completed run simulation tab for example 1 showing the expanded OED plot tab where the plot has a linear scale y-axis.](IVIVE_Vignette_Images/Example1/GUI_IVIVE_RunSimEx1_2.png){width="100%"}
...
![The completed run simulation tab for example 1 showing the expanded OED plot tab where the plot has a log10 scale y-axis.](IVIVE_Vignette_Images/Example1/GUI_IVIVE_RunSimEx1_3.png){width="100%"}
...
![The completed run simulation tab for example 1 showing the expanded bioactivity exposure ratio (BER) table tab.](IVIVE_Vignette_Images/Example1/GUI_IVIVE_RunSimEx1_4.png){width="100%"}
...
![The completed run simulation tab for example 1 showing the expanded BER plot tab where the plot has a log10 scale y-axis.](IVIVE_Vignette_Images/Example1/GUI_IVIVE_RunSimEx1_5.png){width="100%"}
...
![The completed General Parameters tab for example 2.](IVIVE_Vignette_Images/Example1/GUI_IVIVE_GenParsEx1.png){width="100%"}
...
![The completed model specifications tab for example 2.](IVIVE_Vignette_Images/Example2/GUI_IVIVE_ModelSpecEx2.png){width="100%"}
...
library(knitr)
library(kableExtra)
SampleChemsToUpload <- read.csv("Sample_CSV_Files/SampleBioData_10Chems.csv")
...
library(knitr)
library(kableExtra)
SampleChemsToUpload <- read.csv("Sample_CSV_Files/SampleExpData_10Chems.csv")
SampleChemsToUpload[4,4] <- "4.93e-08"
SampleChemsToUpload[3,5] <- "4.79e-08"
SampleChemsToUpload[4,5] <- "4.74e-09"
...
![The completed compound selection tab for example 2.](IVIVE_Vignette_Images/Example2/GUI_IVIVE_CompSelectEx2.png){width="100%"}
...
![The completed advanced parameters tab for example 2.](IVIVE_Vignette_Images/Example2/GUI_IVIVE_AdvParsEx2.png){width="100%"}
...
![The completed run simulation tab for example 2 showing the expanded OED table tab.](IVIVE_Vignette_Images/Example2/GUI_IVIVE_RunSimEx2_1.png){width="100%"}
...
![The completed run simulation tab for example 2 showing the expanded OED plot tab where the OED plot has a linear scale y-axis and showcases the OED distributions against the chemical exposure estimate distributions.](IVIVE_Vignette_Images/Example2/GUI_IVIVE_RunSimEx2_2.png){width="100%"}
...
![The completed run simulation tab for example 2 showing the expanded OED plot tab where the plot has a log10 scale y-axis.](IVIVE_Vignette_Images/Example2/GUI_IVIVE_RunSimEx2_3.png){width="100%"}
...
![The completed run simulation tab for example 2 showing the expanded BER table tab.](IVIVE_Vignette_Images/Example2/GUI_IVIVE_RunSimEx2_4.png){width="100%"}
...
![The completed run simulation tab for example 2 showing the expanded BER plot tab where the plot has a log10 scale y-axis.](IVIVE_Vignette_Images/Example2/GUI_IVIVE_RunSimEx2_5.png){width="100%"}
...
![The completed General Parameters tab for example 3.](IVIVE_Vignette_Images/Example1/GUI_IVIVE_GenParsEx1.png){width="100%"}
...
![The completed model specifications tab for example 3.](IVIVE_Vignette_Images/Example3/GUI_IVIVE_ModelSpecEx3.png){width="100%"}
...
![The completed compound selection tab for example 3.](IVIVE_Vignette_Images/Example3/GUI_IVIVE_CompSelectEx3.png){width="100%"}
...
![The completed advanced parameters tab for example 3.](IVIVE_Vignette_Images/Example3/GUI_IVIVE_AdvParsEx3.png){width="100%"}
...
![The completed run simulation tab for example 3 showing the expanded OED table tab.](IVIVE_Vignette_Images/Example3/GUI_IVIVE_RunSimEx3_1.png){width="100%"}
...
![The completed run simulation tab for example 3 showing the expanded OED plot tab where the plot has a linear scale y-axis.](IVIVE_Vignette_Images/Example3/GUI_IVIVE_RunSimEx3_2.png){width="100%"}
...
![The completed run simulation tab for example 3 showing the expanded OED plot tab where the plot has a log10 scale y-axis.](IVIVE_Vignette_Images/Example3/GUI_IVIVE_RunSimEx3_3.png){width="100%"}
...
![The completed run simulation tab for example 3 showing the expanded BER table and plot tabs, which notifies the user that the calculations were not computed due to lack of exposure data.](IVIVE_Vignette_Images/Example3/GUI_IVIVE_RunSimEx3_4.png){width="100%"}
