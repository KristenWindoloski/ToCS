...
- Utilizes the most recent httk version (2.5.0)
...
![A sample view of the Model Specifications tab.](Introduction_to_ToCS_Vignette_Images/GUI_Introduction_ModelSpecPage.png){width="100%"}
...
![A sample view of the Compound Selection tab.](Introduction_to_ToCS_Vignette_Images/GUI_Introduction_CompoundSelectPage.png){width="100%"}
...
library(knitr)
library(kableExtra)
SampleChemsToUpload <- read.csv("Sample_CSV_Files/SampleCSV.csv")
...
![A second sample view of the Compound Selection tab once all compounds are chosen for simulation.](Introduction_to_ToCS_Vignette_Images/GUI_Introduction_CompoundSelectPage2.png){width="100%"}
...
![A sample view of the Advanced Parameters tab.](Introduction_to_ToCS_Vignette_Images/GUI_Introduction_AdvancedParsPage.png){width="100%"}
...
![A sample view of the Run Simulation tab prior to simulation results being generated.](Introduction_to_ToCS_Vignette_Images/GUI_Introduction_RunSimPage.png){width="100%"}
...
![A second sample view of the Run Simulation tab with all output tabs closed.](Introduction_to_ToCS_Vignette_Images/GUI_Introduction_RunSimPage2.png){width="100%"}
