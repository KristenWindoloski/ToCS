...
![A sample view of the Run Simulation tab prior to simulation results being generated.](GUI_Introduction_RunSimPage2.png){width="100%"}
...
![A second sample view of the Run Simulation tab with all output tabs closed.](GUI_Introduction_RunSimPage.png){width="100%"}
