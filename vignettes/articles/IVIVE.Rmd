...
![The completed General Parameters tab for example 1.](../../man/figures/ivive_genpars_ex1.png){width="100%"}
...
![The completed model specifications tab for example 1 showing the model card.](../../man/figures/ivive_modelspec_ex1.png){width="100%"}
...
kable(SampleChemsToUpload, caption = "A csv file with bioactivity data for all eight chemicals. All values were calculated as the 5th percentile of AC50s (active calls only) for each compound, where the list of AC50s was taken from the cHTS assay database from ICE (https://ice.ntp.niehs.nih.gov/).") %>%    kable_styling() %>%
...
![The completed compound selection tab for example 1.](../../man/figures/ivive_compselect_ex1.png){width="100%"}
...
![The completed advanced parameters tab for example 1.](../../man/figures/ivive_advpars_ex1.png){width="100%"}
...
![The completed run simulation tab for example 1 showing the expanded OED table tab.](../../man/figures/ivive_runsim_ex1_1.png){width="100%"}
...
![The completed run simulation tab for example 1 showing the expanded OED plot tab where the plot has a linear scale y-axis.](../../man/figures/ivive_runsim_ex1_2.png){width="100%"}
...
![The completed run simulation tab for example 1 showing the expanded OED plot tab where the plot has a log10 scale y-axis.](../../man/figures/ivive_runsim_ex1_3.png){width="100%"}
...
![The completed run simulation tab for example 1 showing the expanded bioactivity exposure ratio (BER) table tab.](../../man/figures/ivive_runsim_ex1_4.png){width="100%"}
...
![The completed run simulation tab for example 1 showing the expanded BER plot tab where the plot has a log10 scale y-axis.](../../man/figures/ivive_runsim_ex1_5.png){width="100%"}
...
![The completed General Parameters tab for example 2.](../../man/figures/ivive_genpars_ex1.png){width="100%"}
...
![The completed model specifications tab for example 2.](../../man/figures/ivive_modelspec_ex2.png){width="100%"}
...
![The completed compound selection tab for example 2.](../../man/figures/ivive_compselect_ex2.png){width="100%"}
...
![The completed advanced parameters tab for example 2.](../../man/figures/ivive_advpars_ex2.png){width="100%"}
...
![The completed run simulation tab for example 2 showing the expanded OED table tab.](../../man/figures/ivive_runsim_ex2_1.png){width="100%"}
...
![The completed run simulation tab for example 2 showing the expanded OED plot tab where the OED plot has a linear scale y-axis and showcases the OED distributions against the chemical exposure estimate distributions.](../../man/figures/ivive_runsim_ex2_2.png){width="100%"}
...
![The completed run simulation tab for example 2 showing the expanded OED plot tab where the plot has a log10 scale y-axis.](../../man/figures/ivive_runsim_ex2_3.png){width="100%"}
...
![The completed run simulation tab for example 2 showing the expanded BER table tab.](../../man/figures/ivive_runsim_ex2_4.png){width="100%"}
...
![The completed run simulation tab for example 2 showing the expanded BER plot tab where the plot has a log10 scale y-axis.](../../man/figures/ivive_runsim_ex2_5.png){width="100%"}
...
![The completed General Parameters tab for example 3.](../../man/figures/ivive_genpars_ex1.png){width="100%"}
...
![The completed model specifications tab for example 3.](../../man/figures/ivive_modelspec_ex3.png){width="100%"}
...
![The completed compound selection tab for example 3.](../../man/figures/ivive_compselect_ex3.png){width="100%"}
...
![The completed advanced parameters tab for example 3.](../../man/figures/ivive_advpars_ex3.png){width="100%"}
...
![The completed run simulation tab for example 3 showing the expanded OED table tab.](../../man/figures/ivive_runsim_ex3_1.png){width="100%"}
...
![The completed run simulation tab for example 3 showing the expanded OED plot tab where the plot has a linear scale y-axis.](../../man/figures/ivive_runsim_ex3_2.png){width="100%"}
...
![The completed run simulation tab for example 3 showing the expanded OED plot tab where the plot has a log10 scale y-axis.](../../man/figures/ivive_runsim_ex3_3.png){width="100%"}
...
![The completed run simulation tab for example 3 showing the expanded BER table and plot tabs, which notifies the user that the calculations were not computed due to lack of exposure data.](../../man/figures/ivive_runsim_ex3_4.png){width="100%"}
