...
![The completed General Parameters tab for example 1.](Images/GUI_IVIVE_GenParsEx1.png){width="100%"}
...
![The completed model specifications tab for example 1 showing the model card.](Images/GUI_IVIVE_ModelSpecEx1_1.png){width="100%"}
...
![The completed compound selection tab for example 1.](Images/GUI_IVIVE_CompSelectEx1.png){width="100%"}
...
![The completed advanced parameters tab for example 1.](Images/GUI_IVIVE_AdvParsEx1.png){width="100%"}
...
![The completed run simulation tab for example 1 showing the expanded OED table tab.](Images/GUI_IVIVE_RunSimEx1_1.png){width="100%"}
...
![The completed run simulation tab for example 1 showing the expanded OED plot tab where the plot has a linear scale y-axis.](Images/GUI_IVIVE_RunSimEx1_2.png){width="100%"}
...
![The completed run simulation tab for example 1 showing the expanded OED plot tab where the plot has a log10 scale y-axis.](Images/GUI_IVIVE_RunSimEx1_3.png){width="100%"}
...
![The completed run simulation tab for example 1 showing the expanded bioactivity exposure ratio (BER) table tab.](Images/GUI_IVIVE_RunSimEx1_4.png){width="100%"}
...
![The completed run simulation tab for example 1 showing the expanded BER plot tab where the plot has a log10 scale y-axis.](Images/GUI_IVIVE_RunSimEx1_5.png){width="100%"}
...
![The completed General Parameters tab for example 2.](Images/GUI_IVIVE_GenParsEx1.png){width="100%"}
...
![The completed model specifications tab for example 2.](Images/GUI_IVIVE_ModelSpecEx2.png){width="100%"}
...
![The completed compound selection tab for example 2.](Images/GUI_IVIVE_CompSelectEx2.png){width="100%"}
...
![The completed advanced parameters tab for example 2.](Images/GUI_IVIVE_AdvParsEx2.png){width="100%"}
...
![The completed run simulation tab for example 2 showing the expanded OED table tab.](Images/GUI_IVIVE_RunSimEx2_1.png){width="100%"}
...
![The completed run simulation tab for example 2 showing the expanded OED plot tab where the OED plot has a linear scale y-axis and showcases the OED distributions against the chemical exposure estimate distributions.](Images/GUI_IVIVE_RunSimEx2_2.png){width="100%"}
...
![The completed run simulation tab for example 2 showing the expanded OED plot tab where the plot has a log10 scale y-axis.](Images/GUI_IVIVE_RunSimEx2_3.png){width="100%"}
...
![The completed run simulation tab for example 2 showing the expanded BER table tab.](Images/GUI_IVIVE_RunSimEx2_4.png){width="100%"}
...
![The completed run simulation tab for example 2 showing the expanded BER plot tab where the plot has a log10 scale y-axis.](Images/GUI_IVIVE_RunSimEx2_5.png){width="100%"}
...
![The completed General Parameters tab for example 3.](Images/GUI_IVIVE_GenParsEx1.png){width="100%"}
...
![The completed model specifications tab for example 3.](Images/GUI_IVIVE_ModelSpecEx3.png){width="100%"}
...
![The completed compound selection tab for example 3.](Images/GUI_IVIVE_CompSelectEx3.png){width="100%"}
...
![The completed advanced parameters tab for example 3.](Images/GUI_IVIVE_AdvParsEx3.png){width="100%"}
...
![The completed run simulation tab for example 3 showing the expanded OED table tab.](Images/GUI_IVIVE_RunSimEx3_1.png){width="100%"}
...
![The completed run simulation tab for example 3 showing the expanded OED plot tab where the plot has a linear scale y-axis.](Images/GUI_IVIVE_RunSimEx3_2.png){width="100%"}
...
![The completed run simulation tab for example 3 showing the expanded OED plot tab where the plot has a log10 scale y-axis.](Images/GUI_IVIVE_RunSimEx3_3.png){width="100%"}
...
![The completed run simulation tab for example 3 showing the expanded BER table and plot tabs, which notifies the user that the calculations were not computed due to lack of exposure data.](Images/GUI_IVIVE_RunSimEx3_4.png){width="100%"}
