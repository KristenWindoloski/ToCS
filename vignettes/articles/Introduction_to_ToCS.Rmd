...
![A sample view of the Model Specifications tab.](Images/GUI_Introduction_ModelSpecPage.png){width="100%"}
...
![A sample view of the Compound Selection tab.](Images/GUI_Introduction_CompoundSelectPage.png){width="100%"}
...
![A second sample view of the Compound Selection tab once all compounds are chosen for simulation.](Images/GUI_Introduction_CompoundSelectPage2.png){width="100%"}
...
![A sample view of the Advanced Parameters tab.](Images/GUI_Introduction_AdvancedParsPage.png){width="100%"}
...
![A sample view of the Run Simulation tab prior to simulation results being generated.](Images/GUI_Introduction_RunSimPage.png){width="100%"}
...
![A second sample view of the Run Simulation tab with all output tabs closed.](Images/GUI_Introduction_RunSimPage2.png){width="100%"}
