...
![The opening interface to the ToCS app.](Images/GUI_Introduction_GenParsPage.png){width="100%"}
...
![The completed general parameters tab for example 1.](Images/GUI_PC_GenParsEx1.png){width="100%"}
...
![The completed model specifications tab for example 1.](Images/GUI_PC_ModelSpecEx1.png){width="100%"}
...
![The completed compound selection tab for example 1.](Images/GUI_PC_CompSelectEx1.png){width="100%"}
...
![The completed advanced parameters tab for example 1.](Images/GUI_PC_AdvParsEx1.png){width="100%"}
...
![The run simulation tab prior to simulation completion for example 1.](Images/GUI_PC_RunSimEx1_1.png){width="100%"}
...
![The parameter plots with linear y-axis drop down under the run simulation tab for example 1.](Images/GUI_PC_RunSimEx1_2.png){width="100%"}
...
![The parameter plots with log10 y-axis drop down under the run simulation tab for example 1.](Images/GUI_PC_RunSimEx1_7.png){width="100%"}
...
![The parameter table drop down under the run simulation tab for example 1.](Images/GUI_PC_RunSimEx1_3.png){width="100%"}
...
![The partition coefficients plots with linear y-axis under the run simulation tab for example 1.](Images/GUI_PC_RunSimEx1_4.png){width="100%"}
...
![The partition coefficients plots with log10 y-axis drop down under the run simulation tab for example 1.](Images/GUI_PC_RunSimEx1_8.png){width="100%"}
...
![The partition coefficients table drop down under the run simulation tab for example 1.](Images/GUI_PC_RunSimEx1_5.png){width="100%"}
...
![The simulation parameters drop down under the run simulation tab for example 1.](Images/GUI_PC_RunSimEx1_6.png){width="100%"}
...
![The completed general parameters tab for example 2.](Images/GUI_PC_GenParsEx2.png){width="100%"}
...
![The completed model specifications tab for example 2.](Images/GUI_PC_ModelSpecEx1.png){width="100%"}
...
![The completed compound selection tab for example 2.](Images/GUI_PC_CompSelectEx2.png){width="100%"}
...
![The completed upper part of the advanced parameters tab for example 2.](Images/GUI_PC_AdvParsEx2_1.png){width="100%"}

<br/><br/>

![The completed lower part of the advanced parameters tab for example 2.](Images/GUI_PC_AdvParsEx2_2.png){width="100%"}
...
![The linear y-axis parameter plots under the parameter plots tab for example 2.](Images/GUI_PC_RunSimEx2_1.png){width="100%"}
...
![The log10 y-axis parameter plots under the parameter plots tab for example 2.](Images/GUI_PC_RunSimEx2_6.png){width="100%"}
...
![The table of parameter plot values for example 2.](Images/GUI_PC_RunSimEx2_2.png){width="100%"}
...
![The linear y-axis partition coefficient plots for example 2.](Images/GUI_PC_RunSimEx2_3.png){width="100%"}
...
![The log10 y-axis partition coefficient plots for example 2.](Images/GUI_PC_RunSimEx2_7.png){width="100%"}
...
![The partition coefficients table for example 2.](Images/GUI_PC_RunSimEx2_4.png){width="100%"}
...
![The simulation parameters tab for example 2.](Images/GUI_PC_RunSimEx2_5.png){width="100%"}
