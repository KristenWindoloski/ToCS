...
![The opening interface to the ToCS app for example 1.](../../man/figures/intro_genpars.png){width="100%"}
...
![The completed General Parameters tab for example 1.](../../man/figures/ss_genpars_ex1.png){width="100%"}
...
![The completed model specifications tab for example 1.](../../man/figures/ss_modelspec_ex1.png){width="100%"}
...
![The completed compound selection tab for example 1.](../../man/figures/ss_compselect_ex1.png){width="100%"}
...
![The edited Advanced Parameters tab for example 1.](../../man/figures/ss_advpars_ex1.png){width="100%"}
...
![The run simulation tab ready for simulation for example 1.](../../man/figures/ss_runsim_ex1_1.png){width="100%"}
...
![The run simulation tab with the steady state concentration plot results for example 1.](../../man/figures/ss_runsim_ex1_2.png){width="100%"}
...
![The run simulation tab with the steady state concentration plot results with log10 y-scale for example 1.](../../man/figures/ss_runsim_ex1_3.png){width="100%"}
...
![The run simulation tab with the steady state concentrations table results for example 1.](../../man/figures/ss_runsim_ex1_4.png){width="100%"}
...
![The run simulation tab with the days to steady state table results for example 1.](../../man/figures/ss_runsim_ex1_5.png){width="100%"}
...
![The completed general parameters tab for example 2.](../../man/figures/ss_genpars_ex1.png){width="100%"}
...
kable(SampleChemsToUpload, caption = "A csv file with information for two fictional chemicals.") %>%    kable_styling() %>%
...
![The completed compound selection tab for example 2.](../../man/figures/ss_compselect_ex2.png){width="100%"}
...
![The completed advanced parameters tab for example 2.](../../man/figures/ss_advpars_ex2.png){width="100%"}
...
![The steady state concentration plot with a linear axis for example 2.](../../man/figures/ss_runsim_ex2_1.png){width="100%"}
...
![The steady state concentration plot with a log10 y-axis for example 2.](../../man/figures/ss_runsim_ex2_2.png){width="100%"}
...
![The steady state concentrations table for example 2.](../../man/figures/ss_runsim_ex2_3.png){width="100%"}
...
![The days to steady state table for example 2.](../../man/figures/ss_runsim_ex2_4.png){width="100%"}
