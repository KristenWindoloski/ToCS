...
![The opening interface to the ToCS app for example 1.](Images/GUI_Introduction_GenParsPage.png){width="100%"}
...
![The completed General Parameters tab for example 1.](Images/GUI_SS_GenParsEx1.png){width="100%"}
...
![The completed model specifications tab for example 1.](Images/GUI_SS_ModelSpecEx1.png){width="100%"}
...
![The completed compound selection tab for example 1.](Images/GUI_SS_CompSelectionEx1.png){width="100%"}
...
![The edited Advanced Parameters tab for example 1.](Images/GUI_SS_AdvParsEx1.png){width="100%"}
...
![The completed compound selection tab for example 1 showing all selected compounds.](Images/GUI_SS_RunSimEx1_1.png){width="100%"}
...
![The run simulation tab with the steady state concentration plot results for example 1.](Images/GUI_SS_RunSimEx1_2.png){width="100%"}
...
![The run simulation tab with the steady state concentration plot results with log10 y-scale for example 1.](Images/GUI_SS_RunSimEx1_3.png){width="100%"}
...
![The run simulation tab with the steady state concentrations table results for example 1.](Images/GUI_SS_RunSimEx1_4.png){width="100%"}
...
![The run simulation tab with the days to steady state table results for example 1.](Images/GUI_SS_RunSimEx1_5.png){width="100%"}
...
![The completed general parameters tab for example 2.](Images/GUI_SS_GenParsEx1.png){width="100%"}
...
![The completed model specifications tab for example 2.](Images/GUI_SS_ModelSpecEx2.png){width="100%"}
...
![The completed compound selection tab for example 2.](Images/GUI_SS_CompSelectionEx2.png){width="100%"}
...
![The completed advanced parameters tab for example 2.](Images/GUI_SS_AdvParsEx2.png){width="100%"}
...
![The steady state concentration plot with a linear axis for example 2.](Images/GUI_SS_RunSimEx2_2.png){width="100%"}
...
![The steady state concentration plot with a log10 y-axis for example 2.](Images/GUI_SS_RunSimEx2_3.png){width="100%"}
...
![The steady state concentrations table for example 2.](Images/GUI_SS_RunSimEx2_4.png){width="100%"}
...
![The days to steady state table for example 2.](Images/GUI_SS_RunSimEx2_5.png){width="100%"}
